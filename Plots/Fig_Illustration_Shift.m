...
load('C:\Users\Célia\Desktop\WagnerEdison project\NRT_07_07_2020\Results\01HC_20-Jul-2020\NRT_01HC_post.mat');
Post_T= struct2table(Post); Post_T.Time = smoothdata(Post_T.Time);

bar(Post_T.Time, 'FaceColor', red);
title('Non Solver', 'color', red)
Labels = 'Trials'; TextLabel = 0;
...
subplot(2,1,2)
load('C:\Users\Célia\Desktop\WagnerEdison project\NRT_07_07_2020\Results\10OL_27-Jul-2020\NRT_10OL_post.mat');
Post_T= struct2table(Post);Post_T.Time = smoothdata(Post_T.Time);

bar(Post_T.Time, 'FaceColor', verteau);
